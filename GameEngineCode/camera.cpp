...
{
	objectPosition.YValue = objectPosition.YValue; //Changed this got rid of - on second objectposition, Did it so camera works the same as ever other position
...
{
	m_worldPosition = worldPosition; //Altered because it was originally inverted when moving camera
}
...
//added to get the camera position
